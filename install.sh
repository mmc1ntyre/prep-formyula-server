...
wget --no-check-certificate -O $root_path/recipes/base.sh $recipe_path/base.sh
wget --no-check-certificate -O $root_path/recipes/java.sh $recipe_path/java.sh
wget --no-check-certificate -O $root_path/recipes/base.sh $recipe_path/mariadb.sh
wget --no-check-certificate -O $root_path/recipes/base.sh $recipe_path/jetty.sh
echo -e "\n==> done..."
